...
public class Zombie extends Enemy {
    ...
    ImageHandler imageHandler1 = new ImageHandler("main/Graphics/Enemy/zoimbie1_hold_right.png", 35, 43);
    ImageHandler imageHandler2 = new ImageHandler("main/Graphics/Enemy/zoimbie1_hold_down.png", 43, 35);
    ImageHandler imageHandler3 = new ImageHandler("main/Graphics/Enemy/zoimbie1_left.png", 35, 43);
    ImageHandler imageHandler4 = new ImageHandler("main/Graphics/Enemy/zoimbie1_hold.png", 43, 35);
    private int width1;
    private int width2;
    private int height1;
    private int height2;
    ...
    public Zombie(Vector2D position, int currentDirection) {
        this.width1 = 35;
        this.width2 = 43;
        this.height1 = 43;
        this.height2 = 35;
    ...
    public void aggro(Player player) {
        if (collisions.CollisionEnemyVision(player) || hp <= 4) {
            this.aggro = true;
